...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>TRIPSALE</application>
    ...
    <classAccesses>
        <apexClass>SOQLReport</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Opportunity.SOQL_Tree__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>SOQL_Report__c.SOQLReportExecute__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Report__c.SOQL_Report_Name__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Report__c.SOQL_Report_Parent__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Report__c.SOQL_Source__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Tree__c.Field_Aggregate_Function__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Tree__c.Field_Aggregate_Value__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Tree__c.Field_Label__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Tree__c.Field_Name__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Tree__c.Field_Source__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Tree__c.Tree_Name__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Tree__c.Tree_Object__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>SOQL_Tree__c.Tree_Report_Label__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>SOQL_Report__c-SOQL Report Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>SOQL_Tree__c-SOQL Tree Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <pageAccesses>
        <apexPage>SOQLReportExecute</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    ...
    <tabVisibilities>
        <tab>Distributor_Product__c</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    <tabVisibilities>
        <tab>Hello_World</tab>
